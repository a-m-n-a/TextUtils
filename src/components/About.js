...
export default function About(props) {
    ...
    let myStyle={
        ...
        backgroundColor: props.mode1 === "dark" ? "#38334c":"white"
    }
            ...
            <div className="accordion" id="accordionExample"  >
                ...
                <div className="accordion-item" style={myStyle}>
                    ...
                    <div id="collapseThree" className="accordion-collapse collapse" data-bs-parent="#accordionExample">
                        <div className="accordion-body">
                            This word counter software works in all web browsers like Chrome, Safari, Firefox, Internet Explorer, Opera. It suits to count characters in facebook, blogs, books, excel document, pdf document, essays etc. 
                        </div>
                    </div>
                </div>
            </div>
